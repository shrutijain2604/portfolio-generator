...
//
// The tree is built with inline `content` instead of pre-created blobs, which
// is what keeps this to five requests regardless of how many files a template
// has. Everything shipped is UTF-8 source, so there is no binary case to
// handle; a template that ever needs an image will need blobs with base64
// encoding instead.
//
