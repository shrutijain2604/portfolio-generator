...
export const defaultPortfolioData = {
  ...
  paletteId: "heritage",
  // Artist Profile only: what its player bar claims is playing. Blank on
  // purpose, so that template's own fallback applies; every other template
  // ignores it, exactly like photoUrl and paletteId above.
  nowPlaying: { track: "", artist: "", url: "" },
  links: {
...
// `category` groups templates for the landing page's gallery filter. It is
// descriptive metadata only: no template's rendering depends on it.
export const templates = [
  ...
  },
  {
    ...
    category: "personal",
    name: "Warm & Personal",
    description: "A warm room lit by one window: the light matches the hour you arrive, work hangs as framed prints, and every object casts the same shadow.",
    locked: false,
  },
  {
    id: "dashboard",
    category: "developer",
    name: "Dashboard",
    description: "An operations console: every dated role and degree on one shared time axis you scrub with a crosshair, and your stack read off as a real coverage matrix.",
    locked: false,
  },
  {
    id: "level-up",
    category: "playful",
    name: "Level Up",
    description: "One side-scrolling level: scroll and the parallax world pans, the runner runs, and each section is the next stage.",
    locked: false,
  ...
  },
  {
    ...
    description: "A bound, tabbed notebook: your work mounted as photo prints, index cards, ticket stubs and a sheet of stickers.",
    locked: false,
  },
  {
    id: "spotify",
  ...
  },
  {
    ...
    category: "editorial",
    name: "Front Page",
    description: "A real broadsheet front page: masthead, byline, and color-coded section flags for every story.",
    locked: false,
  },
  {
    id: "prism",
    category: "developer",
    name: "Prism",
    description: "An optical bench: one beam splits through a prism and every section becomes a band of the spectrum, with your stack read off as a real emission spectrum.",
    locked: false,
  },
  {
    id: "holographic",
    category: "playful",
    name: "Holographic",
    description: "Holographic foil as a material: iridescent stock, a stamped seal, and one spectrum that slides across every surface as you move.",
    locked: false,
  },
];
